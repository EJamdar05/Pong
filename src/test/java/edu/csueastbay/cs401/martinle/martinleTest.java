...
import edu.csueastbay.cs401.martinle.*;
import edu.csueastbay.cs401.pong.*;
import edu.csueastbay.cs401.classic.*;
...
public class martinleTest {

    RPGpong game;

    @BeforeEach
    void setUp() {
        game = new RPGpong(false, 1300, 860);
    }
    ...
    void shouldHavePlayer2Paddle() {
        ...
        assertEquals(400, player_2_paddle.getHeight());
    }
    ...
    //changed because game now is HP based
    @Test
    void HittingPlayer1GoalMinusAPointToPlayer2() {
        Puck puck = new Puck(500, 500);
        puck.setCenterX(100);
        puck.setCenterY(100);
        Collision bang = new Collision(
        ...
        game.collisionHandler(puck, bang);
        assertEquals(19, game.getPlayerHP(2));
    }

    //changed because game now is HP based
    @Test
    void HittingPlayer2GoalMinusPointsToPlayer1() {
        Puck puck = new Puck(500, 500);
        puck.setCenterX(100);
        puck.setCenterY(100);
        Collision bang = new Collision(
        ...
        game.collisionHandler(puck, bang);
        assertEquals(17, game.getPlayerHP(1));
    }
    ...
    //added because game now has increasing puck speed after hits
    @Test
    void puckSpeedShouldIncreaseBy1EveryHitAfterResets() {
        Puck puck = new Puck(500, 500);
        puck.setCenterX(100);
        puck.setCenterY(100);
        Collision bang = new Collision(
    ...
    //game victor should return correct player
    @Test
    void victorShouldReturnCorrectPlayer() {
        game.setVictor(1);
